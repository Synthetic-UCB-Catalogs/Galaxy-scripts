...
if ModelParams['ImportSimulation']:
    ...
    if not Code == 'SEVN':
        FileName        = os.environ['UCB_GOOGLE_DRIVE_DIR'] + '/data_products/simulated_binary_populations/monte_carlo_comparisons/' + RunWave + '/' + RunSubType + '/' + Code + '_T0.hdf5'
    else:
        FileName        = os.environ['UCB_GOOGLE_DRIVE_DIR'] + '/data_products/simulated_binary_populations/monte_carlo_comparisons/' + RunWave + '/' + RunSubType + '/' + Code + '_MIST_T0.csv'
    CurrOutDir      = os.environ['UCB_GOOGLE_DRIVE_DIR'] + '/data_products/simulated_galaxy_populations/monte_carlo_comparisons/' + RunWave + '/' + RunSubType + '/'
