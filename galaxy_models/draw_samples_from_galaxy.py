...
if __name__ == "__main__":
    plotSimulatedGalaxySamples(galaxyModelName='Besancon', nSamples=1e6, saveOutput=False) 
    #plotSimulatedGalaxySamples(galaxyModelName='Besancon', nSamples=1e6, saveOutput=True, fnameOutput="small_test.h5", singleComponentToUse=8) 
